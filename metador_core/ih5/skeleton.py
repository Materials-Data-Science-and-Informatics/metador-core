...
from .record import IH5Dataset, IH5Record
...
def init_stub_container(ds: IH5Record, skel: Dict[str, str]):
    """Fill a passed container with stub structure based on a skeleton."""
